...
def generate_and_save_otp(db: Session, recipient: str, purpose: str, channel: str) -> str:
...
def verify_otp(db: Session, recipient: str, code: str, purpose: str, channel: str) -> bool:
    now = datetime.utcnow()

    otp = (
        db.query(models.OtpCode)
        .filter(
            models.OtpCode.recipient == recipient,
